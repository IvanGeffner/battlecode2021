...
public class Enlightment extends MyRobot {
    ...
    final double bigMuckrakerOffset = 10;
    ...
    void updateTypeProportions(){
        ...
        typeProportions[TypeDescription.BIG_MUCKRAKER.ordinal()] = Math.max(1, 1);
    }
    ...
    int smallPoliticianIndex = 1; //politician index (this decides the influence given) [negative values produce lowest tier]
    ...
    int getSafetyInf(){
        ...
        int safety2 = getMaxSlandererInf() - 2*income;
    ...
    int getSlandererInf(int inf){
        ...
        //int msInf = influences[influences.length - 1];
    ...
    final int[] poliTiers = new int[] {16, 24, 38, 56, 78};
