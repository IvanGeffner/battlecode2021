...
public class Politician extends MyRobot {
    ...
    static final double baseEfficiencyMuckraker = 1.5;

    static double efficiencyMuckraker;

    final static int KILL_BONUS = 6;
    final static int STRONG_THRESHOLD = 50;
    ...
    void update(){
        ...
        efficiencyMuckraker = baseEfficiencyMuckraker;
        if (criticalZone){
            efficiencyMuckraker*=2.0;
        }
    }
    ...
    boolean tryProtect(){
        ...
        return surroundOurHQ(PROTECT_RADIUS);
    }
