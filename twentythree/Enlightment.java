...
public class Enlightment extends MyRobot {
    ...
    final int BIG_POLI_MIN_INF = 182;
    ...
    int getBigPoliInf(){
        ...
        if (!minInf.conqueror && rc.getRoundNum() - bigPoliConstructed < MIN_TURNS_BIG_POLI) return 0;
    ...
    final int[] muckTiers = new int[] {1, 19, 62, 101};
